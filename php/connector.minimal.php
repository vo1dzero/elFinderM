...
// begin of elfinder self php config
...
$opts = array(
	...
	'roots' => array(
		...
		array(
			...
			'alias'         => 'VOLUME NAME',				// displayname of volume
			'path'          => '/exampleserver/htdocs/',   	// path to files (root-dir of elFinder)(REQUIRED)
			'URL'           => 'https://example.com/', 		// URL to files (your server-domain (+...)) (REQUIRED)
			'acceptedName' => '/.*/',
			'acceptedDirname' => '/.*/',
